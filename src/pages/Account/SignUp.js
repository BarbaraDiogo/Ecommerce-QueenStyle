...
const SignUp = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <div className="bg-gray-100 lgl:w-1/2 h-[550px] border border-gray-800 rounded-md flex items-center justify-center">
        {successMsg ? (
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-start mdl:items-center gap-2">
                  ...
                  Eu li e concordo com o {" "}
                    <span className="text-blue-500">Termo de Serviço </span>e{" "}
